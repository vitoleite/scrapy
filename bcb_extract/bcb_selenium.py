...
class Extract(object):
    ...
    def __init__(self):
        ...
        self.first_day_prev_month : DateTime = self.data_initial + dateutil.relativedelta.relativedelta(months=-1)
    ...
    def Data_cleaning(self):
        ...
        file        : str = max(glob.iglob("C:/Users/vitor/Downloads/*.csv"), key=os.path.getctime)
